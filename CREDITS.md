...
Third-party assets used on the site. Every entry lists the source and licence.

## Fonts

- **Archivo Variable** — Omnibus-Type, SIL Open Font License 1.1. Self-hosted via
  `@fontsource-variable/archivo`. Display and headline type.
